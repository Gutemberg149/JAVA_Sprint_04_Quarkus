...
//        String sql = "INSERT INTO TBL_HC_CONSULTA_ONLINE (DATA_CONSULTA, STATUS, LINK, ID_PACIENTE, ID_MEDICO, ID_EXAME) VALUES (?, ?, ?, ?, ?, ?)";
//
...
//            }
//
//            comandoSQL.setDate(1, java.sql.Date.valueOf(consultaOnline.getDataConsulta()));
...
//            }
//
//            if (consultaOnline.getIdExame() > 0) {
//                comandoSQL.setInt(6, consultaOnline.getIdExame());
//            } else {
//                comandoSQL.setNull(6, java.sql.Types.INTEGER);
//            }
//
